...
interface PermissionsMatrixProps {
  onSave: (data: { permissions: Record<UserRole, Permission[]>, roles: UserRole[] }) => void;
}
...
const PermissionsMatrix: React.FC<PermissionsMatrixProps> = ({ onSave }) => {
  ...
  const [selectedRoleForPivot, setSelectedRoleForPivot] = useState<UserRole>(UserRole.EMPLOYEE);
