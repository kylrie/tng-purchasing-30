        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="p-6">
                        {recipe.platingPhotoUrl ? (
                            <img
                                ...
                                className="w-full h-[500px] object-cover rounded-xl border border-[#e8e0d4] dark:border-slate-600"
                            />
                        ) : (
                            <div className="w-full h-[500px] bg-gradient-to-br from-amber-100 to-orange-50 dark:from-slate-700 dark:to-slate-600 rounded-xl border border-[#e8e0d4] dark:border-slate-600 flex flex-col items-center justify-center">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl border border-[#e8e0d4] dark:border-slate-700 overflow-hidden">
                    ...
                    <div className="p-6">
                        {embedUrl ? (
                            <div className="relative w-full h-[500px] rounded-xl overflow-hidden border border-[#e8e0d4] dark:border-slate-600">
                                <iframe
                                    src={embedUrl}
                            ...
                            <div 
                                ...
                                className={`w-full h-[500px] bg-gradient-to-br from-stone-600 to-stone-800 dark:from-slate-700 dark:to-slate-600 rounded-xl border border-[#e8e0d4] dark:border-slate-600 flex flex-col items-center justify-center ${onUpdateVideoUrl ? 'cursor-pointer hover:opacity-90 transition-opacity' : ''}`}
                            >
