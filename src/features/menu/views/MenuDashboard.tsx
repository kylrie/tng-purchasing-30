...
const MenuItemCard: React.FC<{
    ...
    return (
        <div className="bg-slate-800/50 rounded-xl border border-slate-700 hover:border-purple-500/50 transition-all p-4">
            {/* Header */}
            ...
            <div className="space-y-2 mb-4">
                <div className="flex justify-between text-sm">
                    ...
                    <span className="text-white font-medium">₱{item.sellingPrice.toFixed(2)}</span>
                </div>
                <div className="flex justify-between text-sm">
                    <span className="text-slate-400">Recipe Cost</span>
                    <span className="text-slate-300">₱{item.calculatedCost.toFixed(2)}</span>
                </div>
                <div className="flex justify-between text-sm">
                    ...
                    <span className="text-green-400 font-medium">₱{item.grossMargin.toFixed(2)}</span>
                </div>
            </div>
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-white flex items-center gap-3">
                        <ChefHat className="text-purple-400" />
                        Menu Engineering
                    </h1>
                ...
                <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-slate-700 hover:bg-slate-600 text-white rounded-xl flex items-center gap-2 text-sm transition-colors disabled:opacity-50"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                    <p className="text-slate-400 text-sm">Avg Food Cost</p>
                ...
                <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                    ...
                    <p className="text-2xl font-bold text-green-400">₱{avgMargin.toFixed(2)}</p>
                </div>
                <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
