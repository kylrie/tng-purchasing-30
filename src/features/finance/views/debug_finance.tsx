                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <select
                            ...
                            className="bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white text-sm py-2 px-3 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        >
                        ...
                        <div className="relative w-full md:w-72">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white placeholder-slate-500 focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm"
                            />
                        </div>
                    </div>
                </div>
                ...
                <Card className="!p-0">
                    <div className="overflow-x-auto max-h-[600px] overflow-y-auto">
                        <table className="w-full text-left text-sm text-slate-900 dark:text-white">
                            <thead className="bg-slate-100/80 dark:bg-slate-900/80 text-xs uppercase font-semibold text-slate-500 dark:text-slate-400 sticky top-0 z-20 backdrop-blur-sm">
                                <tr>
                            ...
                            <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                                {filteredReqs.map(req => (
                                    <tr
                                        key={req.id}
                                        className="hover:bg-slate-50 dark:hover:bg-slate-800/60 cursor-pointer transition-colors border-b border-slate-200 dark:border-slate-700"
                                        onClick={(e) => {
                            ...
                            <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                                {filteredCheckPrepReqs.map(req => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 text-slate-600 dark:text-slate-300">
                                            <div className="truncate max-w-[150px]" title={req.prfDetails?.supplier?.name || 'N/A'}>
                                                {req.prfDetails?.supplier?.name || <span className="text-slate-400 italic">N/A</span>}
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 text-emerald-600 dark:text-emerald-400 font-semibold">
                                            ₱{req.totalAmount?.toLocaleString()}
